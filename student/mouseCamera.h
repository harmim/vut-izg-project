/**
 * @file
 * @brief This file contains function declarations for mouse handling and camera
 * manipulation.
 *
 ...
 *
 * @param button id of pressed button, it can be SDL_BUTTON_LEFT,
 * SDL_BUTTON_RIGHT or SDL_BUTTON_MIDDLE.
 */
 ...
 *
 * @param button id of released button, it can be SDL_BUTTON_LEFT,
 * SDL_BUTTON_RIGHT or SDL_BUTTON_MIDDLE.
 */
