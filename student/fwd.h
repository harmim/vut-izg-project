...
/// This define activates implementation of all tasks and switches to other set
...
/// This define activates deep neural network that analyses student codes using
/// AST, formating, lexical
/// symbols and shallow semantics (for vs. while vs. do-while, 3*a vs a+a+a,
/// cycles vs recursion, etc.)
